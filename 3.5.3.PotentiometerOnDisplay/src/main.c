...
int main()
{
    ...
    while ( 1 )
    {
        ...
        printf( "Value: %d\n", value );
        //this will display first 3 digits as dimmer because the method is supposed to be in a loop. using writeNumberAndWait only makes it worse.
        writeNumber(value);
    }
    return 0;
}